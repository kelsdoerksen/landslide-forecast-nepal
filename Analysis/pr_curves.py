...
df = pd.read_csv('/Users/kelseydoerksen/Desktop/Nature_Comms_Analysis_Plotting/Varying_Forecast/XGB_Forecast_Varying_All.csv')
...
# xgb file: '/Users/kelseydoerksen/Desktop/Nature_Comms_Analysis_Plotting/Varying_Forecast/XGB_Forecast_Varying_All.csv'
...
for f in forecast_unique:
    ...
    plt.title('Precision-Recall Curve for Varying Precipitation Forecast Model using eXtreme Gradient Boosting')
